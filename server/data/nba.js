...
function getNBAData() {
    ...
    for(let i = 0; i < 7; i++) {
        fetch(`https://v1.basketball.api-sports.io/games?league=12&season=2024-2025&date=${date}`, { 
            method: 'get', 
...
function organiseData(data){
    ...
    for(let i = 0; i < count; i++) {
        ...
        try{
            ...
            console.log(`Error in NBA - organiseData(): ${error.errno}`);
        }
